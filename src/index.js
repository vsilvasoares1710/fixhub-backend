...
app.post("/profissionais", (req, res) => {
  res.send(`Profissional Cadastrado com sucesso. ID: ${20}`);
...
app.put("/profissionais/:id", (req, res) => {
  ...
  // Requer token de autenticação. Recebe o id do profisional como parametro e um json dentro do corpo da requisição com os todos os dados do profissional para serem atualizados no banco. Retorna o id do profissional com status 200 em caso de sucesso. Em caso de falha retorna undefined com status de erro.
});

// Rota de remoção do profissional da plataforma
app.delete("/profissionais/:id", (req, res) => {
  res.send(`Perfil do profissional de ID: ${20} alterada com sucesso`);
  // Requer token de autenticação. Recebe o id do profisional como parametro e um json dentro do corpo da requisição com o cpf_cnpj e nome completo do profissional para serem deletados do banco. Em cao de sucesso retorna status 200. Em caso de falha retorna status de erro.
});
